...
$autoloader->register('Elastic\Elasticsearch', DIR_STORAGE . 'vendor/elasticsearch/src/', true);

// elastic/transport
$autoloader->register('Elastic\Transport', DIR_STORAGE . 'vendor/elastic/transport/src/', true);
